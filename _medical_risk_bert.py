...
if __name__ == '__main__':
    ...
    for i in range(len(train_choices)):
        ...
        train_text[i] = train_text[i][len(train_text[i]) - 80:]
    for i in range(len(test_choices)):
        test_choices_A.append(test_choices[i][0]['text'])
        test_text[i] = test_text[i][len(test_text[i]) - 80:]
    ...
    #     {'Train_text': train_text, 'choice_A': train_choices_A, 'choices_B': train_choices_B,
    #      'choice_C': train_choices_C, 'answer': answer})
    df_train = pd.DataFrame({'Train_text': train_text, 'choice_A': train_choices_A, 'answer': answer})
    df_train2 = pd.DataFrame({'Train_text': train_text, 'choice_A': train_choices_B, 'answer': answer})
    df_train3 = pd.DataFrame({'Train_text': train_text, 'choice_A': train_choices_C, 'answer': answer})
